...
syn keyword keykitSpecial	Now MIXED NOTE NOTEOFF NOTEON PRESSURE CONTROLLER PITCHBEND PROGRAM CHANPRESSURE MIDIBYTES
...
if !exists("python_no_builtin_highlight")
  ...
  syn keyword pythonBuiltin	dur type time chan pitch vol length
